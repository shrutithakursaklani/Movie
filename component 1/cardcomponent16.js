            ...
            <div className="pe-5 ps-5 container-fluid">
              <div className="row">
                <div className="col-lg-6"> <h4 className="mt-4 text-light">
                   <a href="#" style={{textDecoration:'none', color:'white'}}>Critically Acclaimed Movies</a> </h4> </div>
...
const data=[
    ...
    {
        img: `images/ca10.webp`,

    }

]

export default Cardcomponent16;