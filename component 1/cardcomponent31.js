            ...
            <div className="pe-5 ps-5 container-fluid">
              <div className="row">
                <div className="col-lg-6"> <h4 className="mt-4 text-light">
                   <a href="#" style={{textDecoration:'none', color:'white'}}>Popular in TalkShow</a> </h4> </div>
            ...
            {data.map((d)=>(
               <div className=" inner" style={{height:"500px"}}> 
                 <div className="rounded  "> 
                    < img src={d.img} style={{height:"350px",width:"100%"}}></img>
                </div>
                <div> 
...
export default Cardcomponent31;